...
func InitLogger(logLevel string, appName string, buildVersion string, logFile string, appender string) error {
...
//func DebugOnly(callback logfunc) {
//	if logrus.Level(atomic.LoadUint32((*uint32)(&LogEntry.Logger.Level))) >= logrus.DebugLevel {
//		callback()
//	}
//}

//Debug write to debug
