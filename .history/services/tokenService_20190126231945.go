...
import (
	...
	"github.mheducation.com/MHEducation/dle-session-management/app/logger"
	"github.mheducation.com/MHEducation/dle-session-management/app/models"
)
...
func CreateUserToken(userID string) (token *models.CustomJWT, err error) {
