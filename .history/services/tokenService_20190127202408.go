...
const (
	privKeyPath = "~/go/src/github.com/dikumarweb/keys/sample_key.key"     // openssl genrsa -out app.rsa keysize
	pubKeyPath  = "~/go/src/github.com/dikumarweb/keys/sample_key.key" // openssl rsa -in app.rsa -pubout > app.rsa.pub
