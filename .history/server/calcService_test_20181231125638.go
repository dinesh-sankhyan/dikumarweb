...
func (m *calcServiceMock) AddValue(a, b float32) int {
	fmt.Println("AddValue function")
	fmt.Printf("Value passed in: %f and %d", a,b)
...
func Test_AddValue(t *testing.T){
   ...
   caclService.On("AddValue",3.4,4.1).Return(7.0)
   result := caclService.AddValue(3,4)
